...
MACRO_CONFIG_INT(GfxWindowedFullscreen, gfx_windowed_fullscreen, 0, 0, 1, CFGFLAG_SAVE|CFGFLAG_CLIENT, "Windowed Fullscreen")
...
MACRO_CONFIG_INT(InpHWCursor, inp_hw_cursor, 1, 0, 1, CFGFLAG_SAVE|CFGFLAG_CLIENT, "Use a hardware cursor")
